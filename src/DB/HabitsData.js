const dataMind = [
    ...
    {
        key: "Estudar programação por 120 minutos",
        value: "Estudar programação por 120 minutos",
    },
    {
    ...
    {
        key: "Ler um livro por 60 minutos",
        value: "Ler um livro por 60 minutos",
    },
    {
    ...
    {
        key: "Trabalhar 120 minutos em um projeto pessoal",
        value: "Trabalhar 120 minutos em um projeto pessoal",
    }
];
const dataMoney = [
    {
    ...
    {
        key: "Economizar 15% do salário",
        value: "Economizar 15% do salário",
    },
    {
...
export default {
    dataMind, dataMoney, dataBody, dataFun
};